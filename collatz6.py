#!/usr/bin/env python3
# Collatz Vertical Rain — dense multi-column fill, next starts at halfway
...
class CollatzVerticalRain:
    def __init__(self, args):
        ...
        pygame.init()
        pygame.display.set_caption("Collatz Vertical Rain — dense fill")
        ...
        # Fill one stream per column initially to avoid blank screen
        ...
        # Set target concurrency based on density
    ...
    def _top_up_density(self):
        # Keep at least target_active streams running to avoid blank gaps
    ...
    def run(self):
        ...
        while running:
            ...
            # Update streams; spawn next numbers at mid-screen
...
def main():
    parser = argparse.ArgumentParser(description="Collatz vertical rain — dense multi-column fill")
